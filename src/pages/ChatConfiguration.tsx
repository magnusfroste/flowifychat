  ...
  const onSubmit = async (values: ChatFormValues) => {
    ...
    try {
      ...
      const customBranding: any = {
        ...
        showBotAvatar: values.showBotAvatar,
        showUserAvatar: values.showUserAvatar,
        showUserBubble: values.showUserBubble,
        userAvatarStyle: values.userAvatarStyle,
        ...
        showAttachmentButton: values.showAttachmentButton,
        showVoiceButton: values.showVoiceButton,
        ...
        showThumbsButtons: values.showThumbsButtons,
        showShareButton: values.showShareButton,
        // Typography
